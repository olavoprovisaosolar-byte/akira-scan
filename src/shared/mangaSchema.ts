...
export const MANGA_CATEGORIES: MangaCategory[] = [
...
export function categoryForGenres(generos: string[] = []): MangaCategory | null {
...
export function categoryById(id: string): MangaCategory | undefined {
